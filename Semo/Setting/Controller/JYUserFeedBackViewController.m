//
//  JYUserFeedBackViewController.m
//  Semo
//
...
#import "JYPlaceholderTextView.h"
#import "JYPhotoCollectionViewCell.h"
#import "JYPredicateMethod.h"
#import "JYPrefixHeader.h"

@interface JYUserFeedBackViewController () <UITextViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UIImagePickerControllerDelegate,UINavigationControllerDelegate>

@property (nonatomic, strong) JYPlaceholderTextView * textView;
...
@implementation JYUserFeedBackViewController
...
- (void)addCollectionViewPicture {
    ...
    //注册对应的cell
    [_collectionV registerClass:[JYPhotoCollectionViewCell class] forCellWithReuseIdentifier:@"cell"];
}
...
- (JYPlaceholderTextView *)textView{
    if (!_textView) {
        _textView = [[JYPlaceholderTextView alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.width - 40, 100)];
...
- (void)sendFeedBack {
    if (self.textView.text.length == 0) {
        ...
        BOOL isPhoneNum = [JYPredicateMethod isMobileNumber:self.textField.text];
        BOOL isEmail = [JYPredicateMethod isValidateEmail:self.textField.text];
        //验证qq未写
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    JYPhotoCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
